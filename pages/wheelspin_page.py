...
class WheelspinPage(BasePage):
    ...
    def initUI(self):
        ...
        self.start_btn.clicked.connect(lambda: self.app.start("wheelspin"))
        self.stop_btn.clicked.connect(self.app.stop)
        self.reset_btn.clicked.connect(lambda: self.app.reset_progress("wheelspin"))
